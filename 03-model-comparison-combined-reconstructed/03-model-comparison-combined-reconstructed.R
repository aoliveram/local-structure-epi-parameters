...
# The 7 Selected Variables (OLD SET)
all_variables <- c(
  "ergm_balance", 
  "ergm_triangles", 
  "ergm_twopath", 
...
if (!file.exists(matrix_file)) {
  ...
  # Update labels for the old set
  all_variables_labels <- c('Balance', 'Triangles', 'Two-Paths', 'Avg. Path Length', 
                            'Avg. Degree', 'Transitivity', 'Modularity')
