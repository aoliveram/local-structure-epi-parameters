...
# Removing some params
vars <- setdiff(vars, c("ergm_isolates", "igraph_avg_closeness", "igraph_avg_path_length", "ergm_nodematch.gender", "ergm_nodematch.grade"))
...
hist(simstats[, igraph_avg_path_length])
```
