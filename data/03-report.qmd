...
## Fitting a RNN using tensorflow

Here, we fit a RNN of the reproductive number as a function of the network 
statistics
...
# Preparing the data
x <- as.matrix(simstats[, igraph_vars, with = FALSE])
y <- as.matrix(simstats[, rt, with = FALSE])
