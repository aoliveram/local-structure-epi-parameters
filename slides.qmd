...
We simulated Susceptible-Exposed-Infected-Recovered \[SEIR\] outbreaks using the [*epiworldR*](https://github.com/UofUEpiBio/epiworldR){target="_blank"} package:

::: {.fragment}
1. Sampled 20,000 **undirected** networks (out of the six types)
:::
...
::: {.fragment}
- Yet the model does not capture some properties of Erdos-Renyi and degree-sequence networks.
:::
