...
if (file.exists(peak_preval_combined_file)) {
  ...
  tex_file_peak_preval <- '03-model-comparison-combined-new-var/03-best_models_table_peak_preval.tex'
  ...
  stargazer(Q_best_models_peak_preval, type = "latex", out = tex_file_peak_preval,
            ...
            # covariate.labels = best_variables_peak_preval, # Commented out to use default labels
...
if (file.exists(peak_time_combined_file)) {
  ...
  tex_file_peak_time <- '03-model-comparison-combined-new-var/03-best_models_table_peak_time.tex'
...
if (file.exists(gentime_combined_file)) {
  ...
  tex_file_gentime <- '03-model-comparison-combined-new-var/03-best_models_table_gentime.tex'
...
if (file.exists(rep_num_combined_file)) {
  ...
  tex_file_rep_num <- '03-model-comparison-combined-new-var/03-best_models_table_rep_num.tex'
